...
import { ChartFrame, PLOT_WIDTH, PLOT_HEIGHT, animValue, animSize, useChartItemHover, hoverStrokeWidth, type ChartItemHoverProps, scaleLinear, scaleBand, Axis, Grid, SEMANTIC_6, AXIS_COLOR, TEXT_COLOR } from '@react-viz-composer/components';
