...
import { ChartFrame, PLOT_WIDTH, PLOT_HEIGHT, animSize, useChartItemHover, hoverOpacity, hoverStrokeWidth, type ChartItemHoverProps, scaleLinear, Axis, Grid, CATEGORY_12, TEXT_COLOR } from '@react-viz-composer/components';
