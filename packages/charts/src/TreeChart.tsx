...
import { ChartFrame, PLOT_HEIGHT, animValue, animSize, useChartItemHover, hoverStrokeWidth, type ChartItemHoverProps, CATEGORY_12 } from '@react-viz-composer/components';
      ...
      {layout.map((n, i) => {
        ...
        return (
          <Rect
            ...
            x={x}
            y={y - NODE_H / 2}
            width={animSize(NODE_W, progress)}
            height={animSize(NODE_H, progress)}
            fill={color}
            stroke={color}
