...
import { ChartFrame, PLOT_WIDTH, PLOT_HEIGHT, animSize, useChartItemHover, hoverStrokeWidth, hoverOpacity, type ChartItemHoverProps, CATEGORY_12, TEXT_COLOR } from '@react-viz-composer/components';
