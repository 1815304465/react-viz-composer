...
import { Path, Text, Rect } from '../shapes';
import { ChartFrame, CHART_WIDTH, CHART_HEIGHT } from './shared/ChartFrame';
import { useChartItemHover, hoverStrokeWidth, type ChartItemHoverProps } from './shared/chartEvents';
import { CATEGORY_12, TEXT_COLOR, AXIS_COLOR } from './shared/palette';
